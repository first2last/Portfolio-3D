...
const VirtualDesk = (props) => {
    const { nodes, materials } = useGLTF('/models/my_virtual_desk.glb')
    return (
        <group {...props} dispose={null}>
            <group name="Cube" position={[0, 75.567, -29.303]}>
                <mesh
                    name="Cube_Mat91_1"
                    castShadow
                    receiveShadow
            ...
            <group name="PC_Gamer" position={[-23.152, 78.928, -43.659]} rotation={[0, -Math.PI / 2, 0]}>
                <mesh
                    name="Clavier_Clavier_0"
                    castShadow
                    receiveShadow
            ...
            />
            <mesh
                name="tasse_��_th��_1_tasse_��_th��_0"
                castShadow
                receiveShadow
            ...
            />
            <mesh
                name="Fauteuil_de_bureau_1_Fauteuil_de_bureau_0"
                castShadow
                receiveShadow
